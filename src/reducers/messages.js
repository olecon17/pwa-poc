  ...
  switch (action.type) {
    ...
    case 'MARK_DECLINED':
      ...
      const modifiedMessage =
        action.type == 'MARK_ACCEPTED'
          ? Object.assign({}, action.msg, { accepted: true })
          : Object.assign({}, action.msg, { rejected: true });
      const messageIndex = messageState.findIndex(
        stateMsg => stateMsg.id == action.msg.id,
      );
