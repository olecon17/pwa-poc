...
const ButtonBar = props => {
  const acceptedClassNames = props.accepted
    ? 'btn btn-outline-success col-1 message_button'
    : 'btn btn-success col-1 message_button';
  const rejectedClassNames = props.rejected
    ? 'btn btn-outline-danger col-1 message_button'
    : 'btn btn-danger col-1 message_button';
  return (
